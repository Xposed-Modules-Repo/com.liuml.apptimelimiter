...
![Version 0.9.1](https://img.shields.io/badge/version-0.9.1-8E44AD)
...
| 到期提醒与延时 | 到期前 5 秒在屏幕顶部显示非模态圆角倒计时，适配横竖屏、刘海与沉浸式全屏；可按设置临时延长 1–60 分钟，时段禁用规则不能被延时绕过。 |
...
| 个性化设置 | 可控制退出提醒、诊断记录和默认延时时长；修改规则后会重置 Hook 本地累计，系统当日时长仍保留。 |
